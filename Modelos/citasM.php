...
class CitasM extends ConexionBD{
    ...
    static  public function EnviarCitaM($tablaBD, $datosC){
        ...
        $pdo = ConexionBD::cBD()->prepare("INSERT INTO $tablaBD(id_doctor, id_consultorio, id_paciente
        documento, inicio, fin,) VALUES(:id_doctor, :id_consultorio, :id_paciente, :documento, :inicio, 
        :fin)");
