	...
	<div class="modal-dialog">
		...
		<div class="modal-content">
			...
			<form method="post">
				...
				$valor = DoctoresC::DoctorC($columna, $valor);
				echo '
					...
					<div class="form-group">
						...
						<h2>Nombre</h2>
							...
							<input type="text" class="form-control input-lg" name="nyaC"
							 value="'.$_SESSION["nombre"].' '.$_SESSION["apellido"].'" readonly>
							
							<input type="hidden" name="Dip" value="'.$resultado["id"].'">
					...
					<div class="form-group">
						...
						<h2>Documento</h2>
							...
							<input type="text" class="form-control input-lg" name="documentoC" 
							value="'.$_SESSION["documento"].'" readonly>
				...
				?>
					<div class="box-body">
						...
						<div class="form-group">
							...
							name="fyhIC" id="fyhIC" readonly>

							<input type="hidden" class="form-control input-lg" 
							name="fyhFC" id="fyhFC" readonly>
						</div>
					</div>
				</div>
